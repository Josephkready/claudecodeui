...
// ResponseCollector (the non-streaming JSON writer) lives in its own
// dependency-free module so it can be unit-tested without importing this whole
// route. See ./response-collector.js.
