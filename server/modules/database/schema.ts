...
CREATE TABLE IF NOT EXISTS sessions (
    ...
    custom_name TEXT,
    -- Provenance of custom_name, so the AI-title worker only rewrites raw
    -- first-prompt titles: NULL = synchronizer-derived (eligible for rewrite),
    -- 'ai' = generated by the local-LM titler, 'user' = renamed in the UI.
    name_source TEXT,
    project_path TEXT,
    jsonl_path TEXT,
    isArchived BOOLEAN DEFAULT 0,
